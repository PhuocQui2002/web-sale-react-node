...
export const getDetailsUser = async (id, access_token) => {
    const res = await axiosJWT.get(`${import.meta.env.VITE_API_URL}/user/getDetails/${id}`, {
        headers: {
...
export const refreshToken = async () => {
    const res = await axios.post(`${import.meta.env.VITE_API_URL}/user/refreshToken`, {
...
//     const res = await axiosJWT.delete(`${import.meta.env.VITE_API_URL}/user/delete-user/${id}`, data, {
//         headers: {
//             token: `Bearer ${access_token}`,
//         }
//     },)
